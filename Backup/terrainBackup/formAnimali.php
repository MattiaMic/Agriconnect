<div class="container-box">
        ...
        <input type="text" class="field" placeholder="Specie"required>
				<input type="text" class="field" placeholder="Peso (in kg)"required>
         <input type="text" class="field" placeholder="Età"required>
           <input type="text" class="field" placeholder=" Prezzo (in €)"required>
                <label for = "bio"><h3> Breve descrizione...</h3></label>
        
        <label for = "bio" placeholder="Qualcosa sul tuo terreno.." >
        <textarea name = "bio" rows = "4" cols = "50" class = "field"> </textarea>
        </label>
    ...
    <div class="main-wrapper">
        <div class="upload-main-wrapper">
                <div class="upload-wrapper">
                        ...
                        <span class="file-upload-text">Carica una foto</span>
